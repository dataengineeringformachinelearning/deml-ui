var DemlUi=(function(e){Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});var t=class extends HTMLElement{static{this.tagName="deml-accordion"}static{this.componentName="accordion"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="accordion">
    ...
    </div>`))}};function nt(){customElements.get(d.tagName)||customElements.define(d.tagName,d)}var c=class extends HTMLElement{static{this.tagName="deml-article"}static{this.componentName="article"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<article class="article"><h1>Article title</h1><p>Body copy.</p></article>'))}};function dt(){customElements.get(c.tagName)||customElements.define(c.tagName,c)}var r=class extends HTMLElement{static{this.tagName="deml-autocomplete"}static{this.componentName="autocomplete"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="autocomplete">
    ...
    </div>`))}};function Ct(){customElements.get(T.tagName)||customElements.define(T.tagName,T)}var D=class extends HTMLElement{static{this.tagName="deml-chart-panel"}static{this.componentName="chart-panel"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<section class="chart-panel" aria-labelledby="chart-panel-title">
    ...
    </div>`))}};function Pt(){customElements.get(w.tagName)||customElements.define(w.tagName,w)}var A=class extends HTMLElement{static{this.tagName="deml-content-layout"}static{this.componentName="content-layout"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="content-layout">
    ...
    <input id="input-email-field" name="email" type="email" placeholder="you@example.com" autocomplete="email">`))}};function Zt(){customElements.get(Q.tagName)||customElements.define(Q.tagName,Q)}var X=class extends HTMLElement{static{this.tagName="deml-input-number"}static{this.componentName="input-number"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<label for="input-number-field">Number</label>
    <input id="input-number-field" name="number" type="number" min="0" max="100" step="1" value="10">`))}};function Qt(){customElements.get(X.tagName)||customElements.define(X.tagName,X)}var $=class extends HTMLElement{static{this.tagName="deml-input-password"}static{this.componentName="input-password"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<label for="input-password-field">Password</label>
    ...
    </header>`))}};function ha(){customElements.get(fe.tagName)||customElements.define(fe.tagName,fe)}var pe=class extends HTMLElement{static{this.tagName="deml-page-section"}static{this.componentName="page-section"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<section class="page-section"><div class="page-section__body">Section body</div></section>'))}};function fa(){customElements.get(pe.tagName)||customElements.define(pe.tagName,pe)}var ge=class extends HTMLElement{static{this.tagName="deml-page-shell"}static{this.componentName="page-shell"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="page-shell">
      <div class="page-shell__inner">
        <p>Constrained page canvas content.</p>
      </div>
    </div>`))}};function pa(){customElements.get(ge.tagName)||customElements.define(ge.tagName,ge)}var be=class extends HTMLElement{static{this.tagName="deml-page-template"}static{this.componentName="page-template"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="page-template">
    ...
    </div>`))}};function Fa(){customElements.get(Ie.tagName)||customElements.define(Ie.tagName,Ie)}var Ge=class extends HTMLElement{static{this.tagName="deml-stack"}static{this.componentName="stack"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="stack">
      <div>Stack item one</div>
      <div>Stack item two</div>
      <div>Stack item three</div>
    </div>`))}};function Ia(){customElements.get(Ge.tagName)||customElements.define(Ge.tagName,Ge)}var ze=class extends HTMLElement{static{this.tagName="deml-stat-card"}static{this.componentName="stat-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<article class="stat-card"><p class="stat-card__label">Sessions</p><p class="stat-card__value">1.2k</p><p class="stat-card__delta">+4%</p></article>'))}};function Ga(){customElements.get(ze.tagName)||customElements.define(ze.tagName,ze)}var Re=class extends HTMLElement{static{this.tagName="deml-status-badge"}static{this.componentName="status-badge"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<span class="status-badge" data-tone="success">
    ...
    <span class="status-badge" data-tone="danger">
      <span class="status-badge__dot" aria-hidden="true"></span>
      Degraded
    </span>`))}};function za(){customElements.get(Re.tagName)||customElements.define(Re.tagName,Re)}var Oe=class extends HTMLElement{static{this.tagName="deml-status-card"}static{this.componentName="status-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<article class="status-card">
    ...
    <span class="status-pill" data-status="maintenance">Maintenance</span>`))}};function Oa(){customElements.get(Ue.tagName)||customElements.define(Ue.tagName,Ue)}var We=class extends HTMLElement{static{this.tagName="deml-switch"}static{this.componentName="switch"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<label class="switch">
    ...
    </label>`))}};function Ua(){customElements.get(We.tagName)||customElements.define(We.tagName,We)}var Ke=class extends HTMLElement{static{this.tagName="deml-table"}static{this.componentName="table"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<table>
    ...
    </table>`))}};function Wa(){customElements.get(Ke.tagName)||customElements.define(Ke.tagName,Ke)}var xe=class extends HTMLElement{static{this.tagName="deml-tabs"}static{this.componentName="tabs"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="tabs">
    ...
    </div>`))}};function Va(){customElements.get(Ze.tagName)||customElements.define(Ze.tagName,Ze)}var Qe=class extends HTMLElement{static{this.tagName="deml-toggle"}static{this.componentName="toggle"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="toggle-group" role="group" aria-label="View">
    ...
    </div>`))}};function Xa(){customElements.get($e.tagName)||customElements.define($e.tagName,$e)}function $a(){et(),tt(),at(),it(),st(),lt(),nt(),dt(),ct(),rt(),mt(),ot(),ut(),ht(),ft(),pt(),gt(),bt(),Nt(),vt(),yt(),Ht(),_t(),Et(),Ct(),Tt(),Dt(),Lt(),Mt(),kt(),St(),Pt(),wt(),At(),Bt(),Ft(),It(),Gt(),zt(),Rt(),Ot(),Ut(),Wt(),Kt(),xt(),Jt(),Yt(),jt(),qt(),Vt(),Zt(),Qt(),Xt(),$t(),ea(),ta(),aa(),ia(),sa(),la(),na(),da(),ca(),ra(),ma(),oa(),ua(),ha(),fa(),pa(),ga(),ba(),Na(),va(),ya(),Ha(),_a(),Ea(),Ca(),Ta(),Da(),La(),Ma(),ka(),Sa(),Pa(),wa(),Aa(),Ba(),Fa(),Ia(),Ga(),za(),Ra(),Oa(),Ua(),Wa(),Ka(),xa(),Ja(),Ya(),ja(),qa(),Va(),Za(),Qa(),Xa()}var ei=["accordion","activity-list","app-footer","app-header","app-layout","app-sidebar","area-chart","article","autocomplete","avatar","badge","banner","bar-chart","box","brand","breadcrumbs","bulk-toolbar","button","button-group","callout","card","card-grid","chart","chart-card","chart-empty-state","chart-panel","checkbox","checkbox-field","cluster","command","confirm-dialog","container","content-layout","dashboard-grid","dialog","disclosure","dropdown","empty-state","error-state","field","file-upload","flashbar","form-grid","form-panel","form-section","grid","help-panel","hud-panel","icon","input-date","input-email","input-number","input-password","input-range","input-search","input-text","input-time","kbd","label","loading-overlay","metric-card","metric-list","microcard","microcard-grid","navbar","navigation-menu","page-back-link","page-header","page-section","page-shell","page-template","pagination","panel-grid","popover","profile","progress","property-filter","radio-group","scroll-area","section","section-header","section-template","select","separator","sheet","sidebar-nav","skeleton","skip-link","spinner","split-panel","stack","stat-card","status-badge","status-card","status-pill","switch","table","tabs","text-field","textarea","theme-toggle","tile-board","timeline","toast","toggle","tooltip","wizard"];return $a(),e.DemlAccordion=t,e.DemlActivityList=a,e.DemlAppFooter=i,e.DemlAppHeader=s,e.DemlAppLayout=l,e.DemlAppSidebar=n,e.DemlAreaChart=d,e.DemlArticle=c,e.DemlAutocomplete=r,e.DemlAvatar=m,e.DemlBadge=o,e.DemlBanner=u,e.DemlBarChart=h,e.DemlBox=f,e.DemlBrand=p,e.DemlBreadcrumbs=g,e.DemlBulkToolbar=b,e.DemlButton=N,e.DemlButtonGroup=v,e.DemlCallout=y,e.DemlCard=H,e.DemlCardGrid=_,e.DemlChart=E,e.DemlChartCard=C,e.DemlChartEmptyState=T,e.DemlChartPanel=D,e.DemlCheckbox=L,e.DemlCheckboxField=M,e.DemlCluster=k,e.DemlCommand=S,e.DemlConfirmDialog=P,e.DemlContainer=w,e.DemlContentLayout=A,e.DemlDashboardGrid=B,e.DemlDialog=F,e.DemlDisclosure=I,e.DemlDropdown=G,e.DemlEmptyState=z,e.DemlErrorState=R,e.DemlField=O,e.DemlFileUpload=U,e.DemlFlashbar=W,e.DemlFormGrid=K,e.DemlFormPanel=x,e.DemlFormSection=J,e.DemlGrid=Y,e.DemlHelpPanel=j,e.DemlHudPanel=q,e.DemlIcon=V,e.DemlInputDate=Z,e.DemlInputEmail=Q,e.DemlInputNumber=X,e.DemlInputPassword=$,e.DemlInputRange=ee,e.DemlInputSearch=te,e.DemlInputText=ae,e.DemlInputTime=ie,e.DemlKbd=se,e.DemlLabel=le,e.DemlLoadingOverlay=ne,e.DemlMetricCard=de,e.DemlMetricList=ce,e.DemlMicrocard=re,e.DemlMicrocardGrid=me,e.DemlNavbar=oe,e.DemlNavigationMenu=ue,e.DemlPageBackLink=he,e.DemlPageHeader=fe,e.DemlPageSection=pe,e.DemlPageShell=ge,e.DemlPageTemplate=be,e.DemlPagination=Ne,e.DemlPanelGrid=ve,e.DemlPopover=ye,e.DemlProfile=He,e.DemlProgress=_e,e.DemlPropertyFilter=Ee,e.DemlRadioGroup=Ce,e.DemlScrollArea=Te,e.DemlSection=De,e.DemlSectionHeader=Le,e.DemlSectionTemplate=Me,e.DemlSelect=ke,e.DemlSeparator=Se,e.DemlSheet=Pe,e.DemlSidebarNav=we,e.DemlSkeleton=Ae,e.DemlSkipLink=Be,e.DemlSpinner=Fe,e.DemlSplitPanel=Ie,e.DemlStack=Ge,e.DemlStatCard=ze,e.DemlStatusBadge=Re,e.DemlStatusCard=Oe,e.DemlStatusPill=Ue,e.DemlSwitch=We,e.DemlTable=Ke,e.DemlTabs=xe,e.DemlTextField=Je,e.DemlTextarea=Ye,e.DemlThemeToggle=je,e.DemlTileBoard=qe,e.DemlTimeline=Ve,e.DemlToast=Ze,e.DemlToggle=Qe,e.DemlTooltip=Xe,e.DemlWizard=$e,e.componentNames=ei,e.defineAccordion=et,e.defineActivityList=tt,e.defineAll=$a,e.defineAppFooter=at,e.defineAppHeader=it,e.defineAppLayout=st,e.defineAppSidebar=lt,e.defineAreaChart=nt,e.defineArticle=dt,e.defineAutocomplete=ct,e.defineAvatar=rt,e.defineBadge=mt,e.defineBanner=ot,e.defineBarChart=ut,e.defineBox=ht,e.defineBrand=ft,e.defineBreadcrumbs=pt,e.defineBulkToolbar=gt,e.defineButton=bt,e.defineButtonGroup=Nt,e.defineCallout=vt,e.defineCard=yt,e.defineCardGrid=Ht,e.defineChart=_t,e.defineChartCard=Et,e.defineChartEmptyState=Ct,e.defineChartPanel=Tt,e.defineCheckbox=Dt,e.defineCheckboxField=Lt,e.defineCluster=Mt,e.defineCommand=kt,e.defineConfirmDialog=St,e.defineContainer=Pt,e.defineContentLayout=wt,e.defineDashboardGrid=At,e.defineDialog=Bt,e.defineDisclosure=Ft,e.defineDropdown=It,e.defineEmptyState=Gt,e.defineErrorState=zt,e.defineField=Rt,e.defineFileUpload=Ot,e.defineFlashbar=Ut,e.defineFormGrid=Wt,e.defineFormPanel=Kt,e.defineFormSection=xt,e.defineGrid=Jt,e.defineHelpPanel=Yt,e.defineHudPanel=jt,e.defineIcon=qt,e.defineInputDate=Vt,e.defineInputEmail=Zt,e.defineInputNumber=Qt,e.defineInputPassword=Xt,e.defineInputRange=$t,e.defineInputSearch=ea,e.defineInputText=ta,e.defineInputTime=aa,e.defineKbd=ia,e.defineLabel=sa,e.defineLoadingOverlay=la,e.defineMetricCard=na,e.defineMetricList=da,e.defineMicrocard=ca,e.defineMicrocardGrid=ra,e.defineNavbar=ma,e.defineNavigationMenu=oa,e.definePageBackLink=ua,e.definePageHeader=ha,e.definePageSection=fa,e.definePageShell=pa,e.definePageTemplate=ga,e.definePagination=ba,e.definePanelGrid=Na,e.definePopover=va,e.defineProfile=ya,e.defineProgress=Ha,e.definePropertyFilter=_a,e.defineRadioGroup=Ea,e.defineScrollArea=Ca,e.defineSection=Ta,e.defineSectionHeader=Da,e.defineSectionTemplate=La,e.defineSelect=Ma,e.defineSeparator=ka,e.defineSheet=Sa,e.defineSidebarNav=Pa,e.defineSkeleton=wa,e.defineSkipLink=Aa,e.defineSpinner=Ba,e.defineSplitPanel=Fa,e.defineStack=Ia,e.defineStatCard=Ga,e.defineStatusBadge=za,e.defineStatusCard=Ra,e.defineStatusPill=Oa,e.defineSwitch=Ua,e.defineTable=Wa,e.defineTabs=Ka,e.defineTextField=xa,e.defineTextarea=Ja,e.defineThemeToggle=Ya,e.defineTileBoard=ja,e.defineTimeline=qa,e.defineToast=Va,e.defineToggle=Za,e.defineTooltip=Qa,e.defineWizard=Xa,e})({});
