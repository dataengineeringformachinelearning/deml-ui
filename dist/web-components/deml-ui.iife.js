var DemlUi=(function(e){Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});var t=class extends HTMLElement{static{this.tagName="deml-accordion"}static{this.componentName="accordion"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="accordion">
    ...
    </aside>`))}};function yt(){customElements.get(y.tagName)||customElements.define(y.tagName,y)}var _=class extends HTMLElement{static{this.tagName="deml-card"}static{this.componentName="card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<article class="card">
    ...
    </article>`))}};function _t(){customElements.get(_.tagName)||customElements.define(_.tagName,_)}var H=class extends HTMLElement{static{this.tagName="deml-card-grid"}static{this.componentName="card-grid"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<div class="card-grid"><article class="card"><h3 class="card-heading">Card</h3></article></div>'))}};function Ht(){customElements.get(H.tagName)||customElements.define(H.tagName,H)}var E=class extends HTMLElement{static{this.tagName="deml-chart"}static{this.componentName="chart"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<figure class="chart-figure">
    ...
    </div>`))}};function Tt(){customElements.get(T.tagName)||customElements.define(T.tagName,T)}var D=class extends HTMLElement{static{this.tagName="deml-chart-panel"}static{this.componentName="chart-panel"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<section class="chart-panel" aria-labelledby="chart-panel-title">
    ...
    </div>`))}};function wt(){customElements.get(w.tagName)||customElements.define(w.tagName,w)}var A=class extends HTMLElement{static{this.tagName="deml-content-layout"}static{this.componentName="content-layout"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="content-layout">
    ...
    </div>`))}};function Rt(){customElements.get(R.tagName)||customElements.define(R.tagName,R)}var z=class extends HTMLElement{static{this.tagName="deml-explore-card"}static{this.componentName="explore-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<article class="explore-card" data-status="operational">
    ...
    </header>`))}};function fa(){customElements.get(fe.tagName)||customElements.define(fe.tagName,fe)}var ge=class extends HTMLElement{static{this.tagName="deml-page-section"}static{this.componentName="page-section"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<section class="page-section"><div class="page-section__body">Section body</div></section>'))}};function ga(){customElements.get(ge.tagName)||customElements.define(ge.tagName,ge)}var be=class extends HTMLElement{static{this.tagName="deml-page-shell"}static{this.componentName="page-shell"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="page-shell">
      <div class="page-shell__inner">
        <p>Constrained page canvas content.</p>
      </div>
    </div>`))}};function ba(){customElements.get(be.tagName)||customElements.define(be.tagName,be)}var Ne=class extends HTMLElement{static{this.tagName="deml-page-template"}static{this.componentName="page-template"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="page-template">
    ...
    </div>`))}};function Ia(){customElements.get(Ie.tagName)||customElements.define(Ie.tagName,Ie)}var Ge=class extends HTMLElement{static{this.tagName="deml-stack"}static{this.componentName="stack"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="stack">
      <div>Stack item one</div>
      <div>Stack item two</div>
      <div>Stack item three</div>
    </div>`))}};function Ga(){customElements.get(Ge.tagName)||customElements.define(Ge.tagName,Ge)}var Re=class extends HTMLElement{static{this.tagName="deml-stat-card"}static{this.componentName="stat-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<article class="stat-card"><p class="stat-card__label">Sessions</p><p class="stat-card__value">1.2k</p><p class="stat-card__delta">+4%</p></article>'))}};function Ra(){customElements.get(Re.tagName)||customElements.define(Re.tagName,Re)}var ze=class extends HTMLElement{static{this.tagName="deml-status-badge"}static{this.componentName="status-badge"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<span class="status-badge" data-tone="success">
    ...
    <span class="status-badge" data-tone="danger">
      <span class="status-badge__dot" aria-hidden="true"></span>
      Degraded
    </span>`))}};function za(){customElements.get(ze.tagName)||customElements.define(ze.tagName,ze)}var Oe=class extends HTMLElement{static{this.tagName="deml-status-card"}static{this.componentName="status-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<article class="status-card">
    ...
    </label>`))}};function Wa(){customElements.get(We.tagName)||customElements.define(We.tagName,We)}var Ke=class extends HTMLElement{static{this.tagName="deml-table"}static{this.componentName="table"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<table>
    ...
    </table>`))}};function Ka(){customElements.get(Ke.tagName)||customElements.define(Ke.tagName,Ke)}var Ye=class extends HTMLElement{static{this.tagName="deml-tabs"}static{this.componentName="tabs"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="tabs">
    ...
    </div>`))}};function Qa(){customElements.get(Qe.tagName)||customElements.define(Qe.tagName,Qe)}var Xe=class extends HTMLElement{static{this.tagName="deml-toggle"}static{this.componentName="toggle"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="toggle-group" role="group" aria-label="View">
    ...
    </div>`))}};function ei(){customElements.get(et.tagName)||customElements.define(et.tagName,et)}function ti(){tt(),at(),it(),st(),lt(),nt(),dt(),ct(),rt(),mt(),ot(),ut(),ht(),pt(),ft(),gt(),bt(),Nt(),vt(),yt(),_t(),Ht(),Et(),Ct(),Tt(),Dt(),Lt(),Mt(),kt(),St(),Pt(),wt(),At(),Bt(),Ft(),xt(),It(),Gt(),Rt(),zt(),Ot(),Ut(),Wt(),Kt(),Yt(),Jt(),jt(),qt(),Vt(),Zt(),Qt(),Xt(),$t(),ea(),ta(),aa(),ia(),sa(),la(),na(),da(),ca(),ra(),ma(),oa(),ua(),ha(),pa(),fa(),ga(),ba(),Na(),va(),ya(),_a(),Ha(),Ea(),Ca(),Ta(),Da(),La(),Ma(),ka(),Sa(),Pa(),wa(),Aa(),Ba(),Fa(),xa(),Ia(),Ga(),Ra(),za(),Oa(),Ua(),Wa(),Ka(),Ya(),Ja(),ja(),qa(),Va(),Za(),Qa(),Xa(),$a(),ei()}var ai=["accordion","activity-list","app-footer","app-header","app-layout","app-sidebar","area-chart","article","autocomplete","avatar","badge","banner","bar-chart","box","brand","breadcrumbs","bulk-toolbar","button","button-group","callout","card","card-grid","chart","chart-card","chart-empty-state","chart-panel","checkbox","checkbox-field","cluster","command","confirm-dialog","container","content-layout","dashboard-grid","dialog","disclosure","dropdown","empty-state","error-state","explore-card","field","file-upload","flashbar","form-grid","form-panel","form-section","grid","help-panel","hud-panel","icon","input-date","input-email","input-number","input-password","input-range","input-search","input-text","input-time","kbd","label","loading-overlay","metric-card","metric-list","microcard","microcard-grid","navbar","navigation-menu","page-back-link","page-header","page-section","page-shell","page-template","pagination","panel-grid","popover","profile","progress","property-filter","radio-group","scroll-area","section","section-header","section-template","select","separator","sheet","sidebar-nav","skeleton","skip-link","spinner","split-panel","stack","stat-card","status-badge","status-card","status-pill","switch","table","tabs","text-field","textarea","theme-toggle","tile-board","timeline","toast","toggle","tooltip","wizard"];return ti(),e.DemlAccordion=t,e.DemlActivityList=a,e.DemlAppFooter=i,e.DemlAppHeader=s,e.DemlAppLayout=l,e.DemlAppSidebar=n,e.DemlAreaChart=d,e.DemlArticle=c,e.DemlAutocomplete=r,e.DemlAvatar=m,e.DemlBadge=o,e.DemlBanner=u,e.DemlBarChart=h,e.DemlBox=p,e.DemlBrand=f,e.DemlBreadcrumbs=g,e.DemlBulkToolbar=b,e.DemlButton=N,e.DemlButtonGroup=v,e.DemlCallout=y,e.DemlCard=_,e.DemlCardGrid=H,e.DemlChart=E,e.DemlChartCard=C,e.DemlChartEmptyState=T,e.DemlChartPanel=D,e.DemlCheckbox=L,e.DemlCheckboxField=M,e.DemlCluster=k,e.DemlCommand=S,e.DemlConfirmDialog=P,e.DemlContainer=w,e.DemlContentLayout=A,e.DemlDashboardGrid=B,e.DemlDialog=F,e.DemlDisclosure=x,e.DemlDropdown=I,e.DemlEmptyState=G,e.DemlErrorState=R,e.DemlExploreCard=z,e.DemlField=O,e.DemlFileUpload=U,e.DemlFlashbar=W,e.DemlFormGrid=K,e.DemlFormPanel=Y,e.DemlFormSection=J,e.DemlGrid=j,e.DemlHelpPanel=q,e.DemlHudPanel=V,e.DemlIcon=Z,e.DemlInputDate=Q,e.DemlInputEmail=X,e.DemlInputNumber=$,e.DemlInputPassword=ee,e.DemlInputRange=te,e.DemlInputSearch=ae,e.DemlInputText=ie,e.DemlInputTime=se,e.DemlKbd=le,e.DemlLabel=ne,e.DemlLoadingOverlay=de,e.DemlMetricCard=ce,e.DemlMetricList=re,e.DemlMicrocard=me,e.DemlMicrocardGrid=oe,e.DemlNavbar=ue,e.DemlNavigationMenu=he,e.DemlPageBackLink=pe,e.DemlPageHeader=fe,e.DemlPageSection=ge,e.DemlPageShell=be,e.DemlPageTemplate=Ne,e.DemlPagination=ve,e.DemlPanelGrid=ye,e.DemlPopover=_e,e.DemlProfile=He,e.DemlProgress=Ee,e.DemlPropertyFilter=Ce,e.DemlRadioGroup=Te,e.DemlScrollArea=De,e.DemlSection=Le,e.DemlSectionHeader=Me,e.DemlSectionTemplate=ke,e.DemlSelect=Se,e.DemlSeparator=Pe,e.DemlSheet=we,e.DemlSidebarNav=Ae,e.DemlSkeleton=Be,e.DemlSkipLink=Fe,e.DemlSpinner=xe,e.DemlSplitPanel=Ie,e.DemlStack=Ge,e.DemlStatCard=Re,e.DemlStatusBadge=ze,e.DemlStatusCard=Oe,e.DemlStatusPill=Ue,e.DemlSwitch=We,e.DemlTable=Ke,e.DemlTabs=Ye,e.DemlTextField=Je,e.DemlTextarea=je,e.DemlThemeToggle=qe,e.DemlTileBoard=Ve,e.DemlTimeline=Ze,e.DemlToast=Qe,e.DemlToggle=Xe,e.DemlTooltip=$e,e.DemlWizard=et,e.componentNames=ai,e.defineAccordion=tt,e.defineActivityList=at,e.defineAll=ti,e.defineAppFooter=it,e.defineAppHeader=st,e.defineAppLayout=lt,e.defineAppSidebar=nt,e.defineAreaChart=dt,e.defineArticle=ct,e.defineAutocomplete=rt,e.defineAvatar=mt,e.defineBadge=ot,e.defineBanner=ut,e.defineBarChart=ht,e.defineBox=pt,e.defineBrand=ft,e.defineBreadcrumbs=gt,e.defineBulkToolbar=bt,e.defineButton=Nt,e.defineButtonGroup=vt,e.defineCallout=yt,e.defineCard=_t,e.defineCardGrid=Ht,e.defineChart=Et,e.defineChartCard=Ct,e.defineChartEmptyState=Tt,e.defineChartPanel=Dt,e.defineCheckbox=Lt,e.defineCheckboxField=Mt,e.defineCluster=kt,e.defineCommand=St,e.defineConfirmDialog=Pt,e.defineContainer=wt,e.defineContentLayout=At,e.defineDashboardGrid=Bt,e.defineDialog=Ft,e.defineDisclosure=xt,e.defineDropdown=It,e.defineEmptyState=Gt,e.defineErrorState=Rt,e.defineExploreCard=zt,e.defineField=Ot,e.defineFileUpload=Ut,e.defineFlashbar=Wt,e.defineFormGrid=Kt,e.defineFormPanel=Yt,e.defineFormSection=Jt,e.defineGrid=jt,e.defineHelpPanel=qt,e.defineHudPanel=Vt,e.defineIcon=Zt,e.defineInputDate=Qt,e.defineInputEmail=Xt,e.defineInputNumber=$t,e.defineInputPassword=ea,e.defineInputRange=ta,e.defineInputSearch=aa,e.defineInputText=ia,e.defineInputTime=sa,e.defineKbd=la,e.defineLabel=na,e.defineLoadingOverlay=da,e.defineMetricCard=ca,e.defineMetricList=ra,e.defineMicrocard=ma,e.defineMicrocardGrid=oa,e.defineNavbar=ua,e.defineNavigationMenu=ha,e.definePageBackLink=pa,e.definePageHeader=fa,e.definePageSection=ga,e.definePageShell=ba,e.definePageTemplate=Na,e.definePagination=va,e.definePanelGrid=ya,e.definePopover=_a,e.defineProfile=Ha,e.defineProgress=Ea,e.definePropertyFilter=Ca,e.defineRadioGroup=Ta,e.defineScrollArea=Da,e.defineSection=La,e.defineSectionHeader=Ma,e.defineSectionTemplate=ka,e.defineSelect=Sa,e.defineSeparator=Pa,e.defineSheet=wa,e.defineSidebarNav=Aa,e.defineSkeleton=Ba,e.defineSkipLink=Fa,e.defineSpinner=xa,e.defineSplitPanel=Ia,e.defineStack=Ga,e.defineStatCard=Ra,e.defineStatusBadge=za,e.defineStatusCard=Oa,e.defineStatusPill=Ua,e.defineSwitch=Wa,e.defineTable=Ka,e.defineTabs=Ya,e.defineTextField=Ja,e.defineTextarea=ja,e.defineThemeToggle=qa,e.defineTileBoard=Va,e.defineTimeline=Za,e.defineToast=Qa,e.defineToggle=Xa,e.defineTooltip=$a,e.defineWizard=ei,e})({});
