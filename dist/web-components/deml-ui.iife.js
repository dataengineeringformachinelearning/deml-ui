var DemlUi=(function(e){Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});var t=class extends HTMLElement{static{this.tagName="deml-accordion"}static{this.componentName="accordion"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="accordion">
    ...
    </ul>`))}};function ft(){customElements.get(h.tagName)||customElements.define(h.tagName,h)}var p=class extends HTMLElement{static{this.tagName="deml-box"}static{this.componentName="box"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="box">
    ...
    </div>`))}};function Lt(){customElements.get(T.tagName)||customElements.define(T.tagName,T)}var D=class extends HTMLElement{static{this.tagName="deml-chart-panel"}static{this.componentName="chart-panel"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<section class="chart-panel" aria-labelledby="chart-panel-title">
    ...
    </div>`))}};function Gt(){customElements.get(x.tagName)||customElements.define(x.tagName,x)}var I=class extends HTMLElement{static{this.tagName="deml-dropdown"}static{this.componentName="dropdown"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="dropdown">
    ...
    </div>`))}};function za(){customElements.get(Ge.tagName)||customElements.define(Ge.tagName,Ge)}var Re=class extends HTMLElement{static{this.tagName="deml-stack"}static{this.componentName="stack"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="stack">
      <div>Stack item one</div>
      <div>Stack item two</div>
      <div>Stack item three</div>
    </div>`))}};function Oa(){customElements.get(Re.tagName)||customElements.define(Re.tagName,Re)}var ze=class extends HTMLElement{static{this.tagName="deml-stat-card"}static{this.componentName="stat-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<article class="stat-card"><p class="stat-card__label">Sessions</p><p class="stat-card__value">1.2k</p><p class="stat-card__delta">+4%</p></article>'))}};function Ua(){customElements.get(ze.tagName)||customElements.define(ze.tagName,ze)}var Oe=class extends HTMLElement{static{this.tagName="deml-status-badge"}static{this.componentName="status-badge"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<span class="status-badge" data-tone="success">
    ...
    </label>`))}};function Ya(){customElements.get(We.tagName)||customElements.define(We.tagName,We)}var Je=class extends HTMLElement{static{this.tagName="deml-table"}static{this.componentName="table"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<table>
    ...
    </table>`))}};function ja(){customElements.get(Je.tagName)||customElements.define(Je.tagName,Je)}var Ye=class extends HTMLElement{static{this.tagName="deml-tabs"}static{this.componentName="tabs"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="tabs">
    ...
    </div>`))}};function si(){customElements.get(at.tagName)||customElements.define(at.tagName,at)}function li(){it(),st(),lt(),nt(),dt(),rt(),ct(),ot(),mt(),ut(),ht(),pt(),ft(),gt(),bt(),Nt(),vt(),_t(),yt(),Ht(),Et(),Ct(),Tt(),Dt(),Lt(),Mt(),kt(),St(),Pt(),wt(),At(),Bt(),Ft(),xt(),It(),Gt(),Rt(),zt(),Ot(),Ut(),Kt(),Wt(),Jt(),Yt(),jt(),qt(),Vt(),Zt(),Qt(),Xt(),$t(),ea(),ta(),aa(),ia(),sa(),la(),na(),da(),ra(),ca(),oa(),ma(),ua(),ha(),pa(),fa(),ga(),ba(),Na(),va(),_a(),ya(),Ha(),Ea(),Ca(),Ta(),Da(),La(),Ma(),ka(),Sa(),Pa(),wa(),Aa(),Ba(),Fa(),xa(),Ia(),Ga(),Ra(),za(),Oa(),Ua(),Ka(),Wa(),Ja(),Ya(),ja(),qa(),Va(),Za(),Qa(),Xa(),$a(),ei(),ti(),ai(),ii(),si()}var ni=["accordion","activity-list","app-footer","app-header","app-layout","app-sidebar","area-chart","article","autocomplete","avatar","badge","banner","bar-chart","box","brand","breadcrumbs","bulk-toolbar","button","button-group","callout","card","card-grid","chart","chart-card","chart-empty-state","chart-panel","checkbox","checkbox-field","cluster","command","confirm-dialog","container","content-layout","dashboard-grid","dialog","disclosure","dropdown","empty-state","error-state","explore-card","field","file-upload","flashbar","form-grid","form-panel","form-section","grid","help-panel","hud-panel","icon","input-date","input-email","input-number","input-password","input-range","input-search","input-text","input-time","kbd","label","loading-overlay","metric-card","metric-list","microcard","microcard-grid","navbar","navigation-menu","page-back-link","page-header","page-section","page-shell","page-template","pagination","panel-grid","popover","profile","progress","property-filter","radio-group","scroll-area","section","section-header","section-template","select","separator","sheet","sidebar-nav","site-footer","skeleton","skip-link","spinner","split-panel","stack","stat-card","status-badge","status-card","status-pill","switch","table","tabs","text-field","textarea","theme-toggle","tile-board","timeline","toast","toc","toggle","tooltip","wizard"];return li(),e.DemlAccordion=t,e.DemlActivityList=a,e.DemlAppFooter=i,e.DemlAppHeader=s,e.DemlAppLayout=l,e.DemlAppSidebar=n,e.DemlAreaChart=d,e.DemlArticle=r,e.DemlAutocomplete=c,e.DemlAvatar=o,e.DemlBadge=m,e.DemlBanner=u,e.DemlBarChart=h,e.DemlBox=p,e.DemlBrand=f,e.DemlBreadcrumbs=g,e.DemlBulkToolbar=b,e.DemlButton=N,e.DemlButtonGroup=v,e.DemlCallout=_,e.DemlCard=y,e.DemlCardGrid=H,e.DemlChart=E,e.DemlChartCard=C,e.DemlChartEmptyState=T,e.DemlChartPanel=D,e.DemlCheckbox=L,e.DemlCheckboxField=M,e.DemlCluster=k,e.DemlCommand=S,e.DemlConfirmDialog=P,e.DemlContainer=w,e.DemlContentLayout=A,e.DemlDashboardGrid=B,e.DemlDialog=F,e.DemlDisclosure=x,e.DemlDropdown=I,e.DemlEmptyState=G,e.DemlErrorState=R,e.DemlExploreCard=z,e.DemlField=O,e.DemlFileUpload=U,e.DemlFlashbar=K,e.DemlFormGrid=W,e.DemlFormPanel=J,e.DemlFormSection=Y,e.DemlGrid=j,e.DemlHelpPanel=q,e.DemlHudPanel=V,e.DemlIcon=Z,e.DemlInputDate=Q,e.DemlInputEmail=X,e.DemlInputNumber=$,e.DemlInputPassword=ee,e.DemlInputRange=te,e.DemlInputSearch=ae,e.DemlInputText=ie,e.DemlInputTime=se,e.DemlKbd=le,e.DemlLabel=ne,e.DemlLoadingOverlay=de,e.DemlMetricCard=re,e.DemlMetricList=ce,e.DemlMicrocard=oe,e.DemlMicrocardGrid=me,e.DemlNavbar=ue,e.DemlNavigationMenu=he,e.DemlPageBackLink=pe,e.DemlPageHeader=fe,e.DemlPageSection=ge,e.DemlPageShell=be,e.DemlPageTemplate=Ne,e.DemlPagination=ve,e.DemlPanelGrid=_e,e.DemlPopover=ye,e.DemlProfile=He,e.DemlProgress=Ee,e.DemlPropertyFilter=Ce,e.DemlRadioGroup=Te,e.DemlScrollArea=De,e.DemlSection=Le,e.DemlSectionHeader=Me,e.DemlSectionTemplate=ke,e.DemlSelect=Se,e.DemlSeparator=Pe,e.DemlSheet=we,e.DemlSidebarNav=Ae,e.DemlSiteFooter=Be,e.DemlSkeleton=Fe,e.DemlSkipLink=xe,e.DemlSpinner=Ie,e.DemlSplitPanel=Ge,e.DemlStack=Re,e.DemlStatCard=ze,e.DemlStatusBadge=Oe,e.DemlStatusCard=Ue,e.DemlStatusPill=Ke,e.DemlSwitch=We,e.DemlTable=Je,e.DemlTabs=Ye,e.DemlTextField=je,e.DemlTextarea=qe,e.DemlThemeToggle=Ve,e.DemlTileBoard=Ze,e.DemlTimeline=Qe,e.DemlToast=Xe,e.DemlToc=$e,e.DemlToggle=et,e.DemlTooltip=tt,e.DemlWizard=at,e.componentNames=ni,e.defineAccordion=it,e.defineActivityList=st,e.defineAll=li,e.defineAppFooter=lt,e.defineAppHeader=nt,e.defineAppLayout=dt,e.defineAppSidebar=rt,e.defineAreaChart=ct,e.defineArticle=ot,e.defineAutocomplete=mt,e.defineAvatar=ut,e.defineBadge=ht,e.defineBanner=pt,e.defineBarChart=ft,e.defineBox=gt,e.defineBrand=bt,e.defineBreadcrumbs=Nt,e.defineBulkToolbar=vt,e.defineButton=_t,e.defineButtonGroup=yt,e.defineCallout=Ht,e.defineCard=Et,e.defineCardGrid=Ct,e.defineChart=Tt,e.defineChartCard=Dt,e.defineChartEmptyState=Lt,e.defineChartPanel=Mt,e.defineCheckbox=kt,e.defineCheckboxField=St,e.defineCluster=Pt,e.defineCommand=wt,e.defineConfirmDialog=At,e.defineContainer=Bt,e.defineContentLayout=Ft,e.defineDashboardGrid=xt,e.defineDialog=It,e.defineDisclosure=Gt,e.defineDropdown=Rt,e.defineEmptyState=zt,e.defineErrorState=Ot,e.defineExploreCard=Ut,e.defineField=Kt,e.defineFileUpload=Wt,e.defineFlashbar=Jt,e.defineFormGrid=Yt,e.defineFormPanel=jt,e.defineFormSection=qt,e.defineGrid=Vt,e.defineHelpPanel=Zt,e.defineHudPanel=Qt,e.defineIcon=Xt,e.defineInputDate=$t,e.defineInputEmail=ea,e.defineInputNumber=ta,e.defineInputPassword=aa,e.defineInputRange=ia,e.defineInputSearch=sa,e.defineInputText=la,e.defineInputTime=na,e.defineKbd=da,e.defineLabel=ra,e.defineLoadingOverlay=ca,e.defineMetricCard=oa,e.defineMetricList=ma,e.defineMicrocard=ua,e.defineMicrocardGrid=ha,e.defineNavbar=pa,e.defineNavigationMenu=fa,e.definePageBackLink=ga,e.definePageHeader=ba,e.definePageSection=Na,e.definePageShell=va,e.definePageTemplate=_a,e.definePagination=ya,e.definePanelGrid=Ha,e.definePopover=Ea,e.defineProfile=Ca,e.defineProgress=Ta,e.definePropertyFilter=Da,e.defineRadioGroup=La,e.defineScrollArea=Ma,e.defineSection=ka,e.defineSectionHeader=Sa,e.defineSectionTemplate=Pa,e.defineSelect=wa,e.defineSeparator=Aa,e.defineSheet=Ba,e.defineSidebarNav=Fa,e.defineSiteFooter=xa,e.defineSkeleton=Ia,e.defineSkipLink=Ga,e.defineSpinner=Ra,e.defineSplitPanel=za,e.defineStack=Oa,e.defineStatCard=Ua,e.defineStatusBadge=Ka,e.defineStatusCard=Wa,e.defineStatusPill=Ja,e.defineSwitch=Ya,e.defineTable=ja,e.defineTabs=qa,e.defineTextField=Va,e.defineTextarea=Za,e.defineThemeToggle=Qa,e.defineTileBoard=Xa,e.defineTimeline=$a,e.defineToast=ei,e.defineToc=ti,e.defineToggle=ai,e.defineTooltip=ii,e.defineWizard=si,e})({});
