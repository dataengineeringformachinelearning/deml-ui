var DemlUi=(function(e){Object.defineProperty(e,Symbol.toStringTag,{value:"Module"});var a=class extends HTMLElement{static{this.tagName="deml-app-layout"}static{this.componentName="app-layout"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="app-layout">
    ...
    </article>`))}};function Ae(){customElements.get(h.tagName)||customElements.define(h.tagName,h)}var u=class extends HTMLElement{static{this.tagName="deml-card-grid"}static{this.componentName="card-grid"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<div class="card-grid"><article class="card"><h3 class="card-heading">Card</h3></article></div>'))}};function Ie(){customElements.get(u.tagName)||customElements.define(u.tagName,u)}var p=class extends HTMLElement{static{this.tagName="deml-chart"}static{this.componentName="chart"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="chart-board" data-chart-board data-chart-ymax="auto">
    ...
    </div>`))}};function Ge(){customElements.get(p.tagName)||customElements.define(p.tagName,p)}var f=class extends HTMLElement{static{this.tagName="deml-chart-card"}static{this.componentName="chart-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="chart-board" data-chart-board data-chart-ymax="auto">
    ...
    </div>`))}};function Ke(){customElements.get(H.tagName)||customElements.define(H.tagName,H)}var E=class extends HTMLElement{static{this.tagName="deml-content-layout"}static{this.componentName="content-layout"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="content-layout">
    ...
    </dialog>`))}};function Je(){customElements.get(T.tagName)||customElements.define(T.tagName,T)}var k=class extends HTMLElement{static{this.tagName="deml-dropdown"}static{this.componentName="dropdown"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="dropdown">
    ...
    </div>`))}};function Ze(){customElements.get(D.tagName)||customElements.define(D.tagName,D)}var M=class extends HTMLElement{static{this.tagName="deml-explore-card"}static{this.componentName="explore-card"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<article class="explore-card" data-status="operational">
    ...
    </header>`))}};function ba(){customElements.get(V.tagName)||customElements.define(V.tagName,V)}var j=class extends HTMLElement{static{this.tagName="deml-page-section"}static{this.componentName="page-section"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML='<section class="page-section"><div class="page-section__body">Section body</div></section>'))}};function va(){customElements.get(j.tagName)||customElements.define(j.tagName,j)}var J=class extends HTMLElement{static{this.tagName="deml-page-shell"}static{this.componentName="page-shell"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<div class="page-shell">
    ...
    </label>`))}};function za(){customElements.get(be.tagName)||customElements.define(be.tagName,be)}var ve=class extends HTMLElement{static{this.tagName="deml-table"}static{this.componentName="table"}connectedCallback(){this.dataset.demlHydrated!=="true"&&(this.dataset.demlHydrated="true",this.hasChildNodes()||(this.innerHTML=`<table>
